...
from FlaskBlog.form import RegistrationForm,LoginForm,updateForm,newPostForm,SearchForm
...
def search():
    form = SearchForm()
    searched = form.searched.data  # Store searched term outside the conditional block
